...
## param optimization and catalog with >10x, map all lc samples to hc catalog
(update 1/18/2026)

i'm going to re-do the param opt steps for all species in order to make it consistent and ensure that we varied param space appropriately for M and n. the idea here is to figure out first which samples are low coverage/high coverage (>10x), then map all of the low coverage samples to the high coverage catalog. that will be the param_opt script. then for the best combination of parameter space, that catalog will be run through the populations module and then in a separate script filtered with VCF tools. 

here's the new working script for parameter optimization: 

```bash
(base) [eppley.m@explorer-01 munkiana]$ cat param_opt_munkiana.sh 
#!/bin/bash
...
BASE_DIR="/projects/gatins/2025_Mobulid/munkiana"
POPMAP="/projects/gatins/2025_Mobulid/munkiana/pop_map_munkiana"

echo "Sample list:"
cat ${POPMAP}

# high coverage samples (>10x) for catalog - these are based on prior outputs (see github)
HIGH_COV="mu_11 mu_12 mu_21 mu_3 mu_4 mu_7 NIC_2725_01 NIC_2728_01 NIC_2732_01 NIC_2736_01 NIC_2738_01 NIC_2740_01 PER_DCLCW130_MM PER_DCLCW87_MM PER_DPPW019_MM PER_DPPW28_MM PER_DPPW98_MM"

# all samples
ALL_SAMPLES="mu_11 mu_12 mu_14 mu_19 mu_2 mu_21 mu_23 mu_25 mu_3 mu_4 mu_7 mu_8 NIC_2725_01 NIC_2726_01 NIC_2727_01 NIC_2728_01 NIC_2731_01 NIC_2731_02 NIC_2732_01 NIC_2736_01 NIC_2738_01 NIC_2740_01 NIC_6013_1 PER_DCLCW130_MM PER_DCLCW87_MM PER_DPPW019_MM PER_DPPW025_MM PER_DPPW033_MM PER_DPPW28_MM PER_DPPW98_MM"
...
# Testing M=2,3,4,5 with n=M and n=M+1
for M in 2 3 4 5; do
    ...
    for n in $M $((M + 1)); do
        ...
        # cstacks - HIGH COVERAGE >10x samples only
