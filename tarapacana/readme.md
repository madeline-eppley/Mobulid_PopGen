...
4. `run_populations_gal.sh` re-runs just the populations module with the new groupings. input was the existing STACKS catalog from the final_m3_M2_n2/ folder. The popmap_gal.txt with new assignments (EAST=5, GAL=4, CTR=3, WST=1). n=13 samples remained after filtering (BYC_RMT_59 was removed during VCFtools filtering). This is the final dataset.
